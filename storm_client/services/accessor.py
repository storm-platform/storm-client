...
class CompendiumAccessor(BaseServiceAccessor):
    ...
    def draft(self, project_id):
        return CompendiumService(self._url, self._access_token, project_id, as_draft=True)

    def record(self, project_id):
        return CompendiumService(self._url, self._access_token, project_id, as_draft=False)
    ...
    def search(self, project_id, user_records=False):
        return CompendiumSearchService(self._url, self._access_token, project_id, user_records)
